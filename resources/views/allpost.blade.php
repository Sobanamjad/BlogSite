...
<body>
    ...
    <div class="hero-header" style="position: relative;">
        <!-- Logout Button -->
        <form action="{{ route('logout') }}" method="POST" style="position: absolute; top: 1rem; right: 1rem;">
            @csrf
        ...
        <div class="container">
            ...
            <p class="hero-subtitle">Discover amazing content from our community</p>
        </div>
    </div>
    ...
    <div class="container main-container">
        <div class="row g-4">
            @foreach ($data as $post)
                <div class="col-md-6">
                    <div class="card post-card h-100 shadow-sm loading-animation"
                            ...
                            <div>
                                <div class="meta">
                                    <p class="small text-muted mb-2">
                                        ...
                                        By <a href="{{ route('author.posts', $post->user->slug) }}" class="author-link">
