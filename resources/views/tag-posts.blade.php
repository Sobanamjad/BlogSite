...
<body>
    ...
    <div class="hero-header">
        ...
        <div class="container">
            ...
            <p class="hero-subtitle">
                ...
                Explore posts by topic and discover new content
            </p>
        </div>
    </div>
    ...
    <div class="container main-container">
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="meta-section">
                                <div class="meta-item">
                                    ...
                                    @if ($post->user)
                                        <a href="{{ route('author.posts', $post->user) }}" class="author-link">
                                            {{ $post->user->name }}
                                        </a>
                                    @else
                                ...
                                <a href="{{ route('view.post', $post->slug) }}" class="btn btn-sm btn-primary">
                                    Read More
                                </a>
                            </div>
                        </div>
            ...
            @empty
                <div class="col-12">
                    <div class="no-posts loading-animation">
                        <i class="fas fa-tags"></i>
                        <h3>No Posts Found</h3>
                        <p>No posts available under this tag. Please check back later for new content.</p>
                    </div>
                </div>
            @endforelse
        </div>
